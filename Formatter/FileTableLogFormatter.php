...
/**
 * Log formatter for plain table-like file content.
 */
class FileTableLogFormatter extends Component {
    ...
    public function Format($Message, $Level, $Data, $Timestamp=null) {
        ...
        $Values[]= json_encode($Data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);

        foreach($Values as &$Item) {
            if (!is_scalar($Item)) { // stringify value
                $Item= json_encode($Data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
            }
